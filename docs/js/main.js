...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_accord_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/accord.js */ "./src/js/components/accord.js");
/* harmony import */ var _components_loan_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/loan.js */ "./src/js/components/loan.js");
/* harmony import */ var _components_raiting_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/raiting.js */ "./src/js/components/raiting.js");
...
/* harmony import */ var _components_mob_sticky_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/mob-sticky.js */ "./src/js/components/mob-sticky.js");
/* harmony import */ var _components_testi_cards_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/testi-cards.js */ "./src/js/components/testi-cards.js");
...
class LoanSlider {
  constructor() {
    ...
    this.sliderElement = document.getElementById(config.sliderId || "loanSlider");
    this.amountDisplay = document.getElementById(config.amountDisplayId || "loanAmountDisplay");
    this.buttonElement = document.getElementById(config.buttonId || "loanButton");
  ...
  init() {
    ...
    this.updateButton();
    this.sliderElement.addEventListener("input", this.handleSliderInput.bind(this));
  ...
  updateAmountDisplay() {
    this.amountDisplay.textContent = `${this.formatNumber(this.currentValue)} ${this.currency}`;
  }
  updateButton() {
    this.buttonElement.textContent = `Получить ${this.formatNumber(this.currentValue)} ${this.currency}`;
  }
...
/***/ "./src/js/components/mob-sticky.js":
/*!*****************************************!*\
  !*** ./src/js/components/mob-sticky.js ***!
  \*****************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
new swiper__WEBPACK_IMPORTED_MODULE_0__.Swiper(".review-slider", {
  slidesPerView: 3,
  spaceBetween: 20,
  navigation: {
...
/***/ "./src/js/components/testi-cards.js":
/*!******************************************!*\
  !*** ./src/js/components/testi-cards.js ***!
  \******************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (phoneInput.length > 0) {
    const initMask = inp => {
      mask = (0,imask__WEBPACK_IMPORTED_MODULE_1__["default"])(inp, {
        mask: "000 000 000",
        lazy: true,
        placeholderChar: "_",
        onAccept: value => {
